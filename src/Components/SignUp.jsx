        ...
        <>
          {
            isTablet ? 
              <Stack height="100vh" flexDirection={
                ...
                background:DarkOrLight ? "#0f0f0f" : "#ffff" 
            }}>
                ...
                <div style={{
                    ...
                    boxShadow:localStorage.getItem("lang") === "ar" || localStorage.getItem("lang") === "fa" ? "10px 0px 10px #00000088" : "-10px 0px 10px #00000088",
                    // Positions
                    marginLeft:"-10vw",                
                    // Radius
                    ...
                    // Border
                    borderLeft: localStorage.getItem("lang") === "ar" || localStorage.getItem("lang") === "fa" ? "" : DarkOrLight ?  "1px #000 solid" : "1px #AAA solid",
                    borderRight: localStorage.getItem("lang") === "ar" || localStorage.getItem("lang") === "fa" ? DarkOrLight ?  "1px #000 solid" : "1px #AAA solid" : "",
                    // Z-Index
                    zIndex:"1",
                    // Add-ons
                ...
                className={
                    DarkOrLight ? "Dark-Scroll" : "Light-Scroll"
                }
